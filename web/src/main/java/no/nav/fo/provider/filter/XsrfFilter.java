package no.nav.fo.provider.filter;
...
import static no.nav.fo.provider.sikkerhet.XsrfUtils.sjekkXsrfToken;
import static no.nav.fo.provider.sikkerhet.XsrfUtils.xsrfCookie;
