...
import static no.nav.fo.config.feed.OppfolgingerfeedConfig.finnSisteIdNumerisk;
import static no.nav.fo.config.feed.OppfolgingerfeedConfig.finnSisteIdTidspunkt;
