package no.nav.fo.veilarbportefolje.routes;

import no.nav.fo.veilarbportefolje.database.BrukerRepository;
import no.nav.fo.veilarbportefolje.database.PersistentOppdatering;
import no.nav.fo.veilarbportefolje.domene.BrukerinformasjonFraFil;
import no.nav.fo.veilarbportefolje.domene.YtelseMapping;
