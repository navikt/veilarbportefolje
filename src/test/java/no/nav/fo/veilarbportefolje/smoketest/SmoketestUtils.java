package no.nav.fo.veilarbportefolje.smoketest;

import no.nav.dialogarena.smoketest.SmoketestException;
import no.nav.dialogarena.smoketest.SmoketestFSS;
import no.nav.fo.veilarbportefolje.smoketest.domene.EnheterResponse;
import no.nav.fo.veilarbportefolje.smoketest.domene.PortefoljeEnhet;
