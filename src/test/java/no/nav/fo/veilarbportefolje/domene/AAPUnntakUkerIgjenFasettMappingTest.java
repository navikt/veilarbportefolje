...
import no.nav.fo.veilarbportefolje.exception.UgyldigAntallDagerIgjenException;
import org.junit.jupiter.api.Test;

import static no.nav.fo.veilarbportefolje.domene.AAPUnntakUkerIgjenFasettMapping.*;
...
class AAPUnntakUkerIgjenFasettMappingTest {
    ...
    void finnUkemapping() {
        ...
        assertEquals(UKE96_107, finnUkeMapping(523).get());
    }
