...
import static no.nav.fo.veilarbportefolje.domene.AAPMaxtidUkeFasettMapping.*;
import static no.nav.fo.veilarbportefolje.domene.DagpengerUkeFasettMapping.*;
import static no.nav.fo.veilarbportefolje.domene.ManedFasettMapping.*;
