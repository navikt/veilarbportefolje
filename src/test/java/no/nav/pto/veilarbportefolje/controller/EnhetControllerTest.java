...
public class EnhetControllerTest {
    ...
    public void initController() {
        ...
        enhetController = new EnhetController(opensearchService, mock(PostgresService.class), authService, mock(TiltakService.class), mock(MetricsClient.class), mock(UnleashService.class));
