...
import static no.nav.pto.veilarbportefolje.feed.aktivitet.AktivitetData.aktivitetTyperList;
import static no.nav.pto.veilarbportefolje.feed.aktivitet.AktivitetUtils.*;
