...
public class LonnstilskuddUtAvArenaTest extends EndToEndTest {
    ...
    //Teste en raw sql-query som prøver å sammenligne to tabeller

    @Test
    public void skal_indeksere_bruker_naar_vi_faar_lonnstilskudd_fra_DAB_og_feature_toggle_er_enablet() {
        when(unleashService.isEnabled(FeatureToggle.LONNSTILSKUDD_FRA_DAB)).thenReturn(true);
        ...
        Map.Entry<String, String> til = Map.entry("MIDLONTIL", "Midlertidig lønnstilskudd");
    ...
    @Test
    public void skal_ikke_indeksere_bruker_naar_vi_faar_lonnstilskudd_fra_DAB_og_feature_toggle_er_disablet() {
        when(unleashService.isEnabled(FeatureToggle.LONNSTILSKUDD_FRA_DAB)).thenReturn(false);
        ...
        verifiserAsynkront(5, TimeUnit.SECONDS, () -> {
                    ...
                    assertThat(response.getAntall()).isEqualTo(0);
                }
        );
    }
    ...
    @Test
    public void skal_handtere_alle_tiltakstyper_fra_Arena_naar_feature_toggle_er_disablet() {
        when(unleashService.isEnabled(FeatureToggle.LONNSTILSKUDD_FRA_DAB)).thenReturn(false);
