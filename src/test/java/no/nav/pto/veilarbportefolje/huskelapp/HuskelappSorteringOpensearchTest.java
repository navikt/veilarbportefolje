...
import static no.nav.pto.veilarbportefolje.arbeidsliste.Arbeidsliste.Kategori.*;
import static no.nav.pto.veilarbportefolje.util.OpensearchTestClient.pollOpensearchUntil;
import static no.nav.pto.veilarbportefolje.util.TestDataUtils.randomAktorId;
import static org.assertj.core.api.AssertionsForClassTypes.assertThat;

public class HuskelappSorteringOpensearchTest extends EndToEndTest {
    private final OpensearchService opensearchService;
    private final OpensearchIndexerV2 opensearchIndexerV2;

    @Autowired
    public HuskelappSorteringOpensearchTest(OpensearchService opensearchService, OpensearchIndexerV2 opensearchIndexerV2) {
