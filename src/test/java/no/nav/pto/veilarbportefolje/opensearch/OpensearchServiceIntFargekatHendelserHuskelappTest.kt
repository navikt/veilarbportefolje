...
class OpensearchServiceIntFargekatHendelserHuskelappTest @Autowired constructor(
    ...
    @Test
    fun skal_kunne_sortere_pa_dato_frist_for_hendelsefilter_kandidat_for_utgang() {
        // Given
        val aktoridBruker1 = AktorId.of("1111111111111")
        val aktoridBruker2 = AktorId.of("2222222222222")
        val aktoridBruker3 = AktorId.of("3333333333333")

        val datoFristBruker1 = ZonedDateTime.of(2024, 1, 1, 12, 0, 0, 0, ZoneId.systemDefault())
        val datoFristBruker2 = ZonedDateTime.of(2025, 1, 1, 12, 0, 0, 0, ZoneId.systemDefault())
        val datoFristBruker3 = ZonedDateTime.of(2023, 1, 1, 12, 0, 0, 0, ZoneId.systemDefault())

        val kandidatBruker1 = genererRandomHendelse(
            kategori = Kategori.KANDIDAT_FOR_UTMELDING,
            hendelseDatoFrist = datoFristBruker1
        ).hendelse
        val kandidatBruker2 = genererRandomHendelse(
            kategori = Kategori.KANDIDAT_FOR_UTMELDING,
            hendelseDatoFrist = datoFristBruker2
        ).hendelse
        val kandidatBruker3 = genererRandomHendelse(
            kategori = Kategori.KANDIDAT_FOR_UTMELDING,
            hendelseDatoFrist = datoFristBruker3
        ).hendelse
