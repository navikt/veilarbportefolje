...
create view UTLOPTE_AKTIVITETER as
(
  SELECT AK.AKTIVITETID, AK.AKTOERID, AK.AKTIVITETTYPE, AK.TILDATO, MAP.PERSONID
  FROM AKTIVITETER AK
    LEFT JOIN AKTOERID_TO_PERSONID MAP ON MAP.AKTOERID = AK.AKTOERID AND MAP.GJELDENE = 1
)