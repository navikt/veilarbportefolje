CREATE TABLE SIST_LEST_AKTIVITETSPLANEN (
     AKTOERID VARCHAR(20) NOT NULL,
     SIST_LEST_AKTIVITETSPLANEN TIMESTAMP,
...
SELECT MAP.AKTOERID                      AS AKTOERID,
       ...
       VS.ANSVARLIG_VEILEDER_NAVN        AS ANSVARLIG_VEILEDER_NAVN,
       ...
       SLA.SIST_LEST_AKTIVITETSPLANEN    AS SIST_LEST_AKTIVITETSPLANEN,
...
FROM OPPFOLGINGSBRUKER OB
         ...
         LEFT JOIN SIST_LEST_AKTIVITETSPLANEN SLA ON SLA.AKTOERID = MAP.AKTOERID
