ALTER TABLE OPPFOLGINGSBRUKER_ARENA ADD FODSELS_DATO DATE;
ALTER TABLE OPPFOLGINGSBRUKER_ARENA ADD KJONN VARCHAR(1);

CREATE UNIQUE INDEX ENHET_IDX ON OPPFOLGINGSBRUKER_ARENA (NAV_KONTOR);
