CREATE TABLE VEDTAKSTATUS (
    ...
    HOVEDMAL VARCHAR (20),
    SIST_REDIGERT_TIDSPUNKT TIMESTAMP,
...
CREATE VIEW VW_PORTEFOLJE_INFO AS (
  SELECT
    ...
    VS.STATUS AS VEDTAK_STATUS,
    VS.STATUS_ENDRET_TIDSPUNKT AS VEDTAK_STATUS_ENDRET_TIDSPUNKT
  FROM
    ...
    LEFT JOIN VEDTAKSTATUS VS ON VS.AKTOERID = MAP.AKTOERID
