CREATE TABLE VEDTAKSTATUS_DATA (
    ...
    VEDTAKSTATUS VARCHAR(20),
    INNSATSGRUPPE VARCHAR(20),
    HOVEDMAL VARCHAR (20),
    VEDTAK_SIST_REDIGERT_TIDSPUNKT TIMESTAMP,
...
CREATE VIEW VW_PORTEFOLJE_INFO AS (
  ...
  FROM
    ...
    LEFT JOIN (SELECT VEDTAKSTATUS, VEDTAK_STATUS_ENDRET_TIDSPUNKT FROM VEDTAKSTATUS_DATA WHERE (VEDTAKSTATUS = 'UTKAST_OPPRETTET' OR VEDTAKSTATUS = 'SENDT_TIL_BESLUTTER')) VS ON VS.AKTOERID = MAP.AKTOERID
