...
public class ApplicationConfig implements ApiApplication.NaisApiApplication {
    ...
    public static final String LOEPENDEYTELSER_PATH_PROPERTY = "LOEPENDEYTELSER_PATH";
    public static final String LOEPENDEYTELSER_FILNAVN_PROPERTY = "LOEPENDEYTELSER_FILNAVN";
