...
public class KafkaConfig {
    ...
    public enum Topic {
        ...
        KAFKA_AKTIVITER_CONSUMER_TOPIC("aapen-fo-endringPaaAktivitet-v3-" + requireKafkaTopicPostfix()),
        KAFKA_AKTIVITER_CONSUMER_TOPIC_V4("aapen-fo-endringPaaAktivitet-v4-" + requireKafkaTopicPostfix()),
    ...
    @Bean
    public KafkaConsumerRunnable<String> kafkaAktivitetV4Consumer(AktivitetService aktivitetService, UnleashService unleashService, MetricsClient metricsClient) {
        return new KafkaConsumerRunnable<>(
                aktivitetService,
                unleashService,
                KafkaProperties.kafkaProperties(KafkaAutoOffset.EARLIEST),
                Topic.KAFKA_AKTIVITER_CONSUMER_TOPIC_V4,
                metricsClient
        );
    }
