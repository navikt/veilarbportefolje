...
@AllArgsConstructor
@NoArgsConstructor
public class PortefoljebrukerFrontendModell2 {
    String fnr;
    String aktoerid;
    String fornavn;
    String etternavn;
    ...
    public static PortefoljebrukerFrontendModell2 of(PortefoljebrukerOpensearchModell brukerOpensearchModell, boolean ufordelt) {
        ...
        return new PortefoljebrukerFrontendModell2()
    ...
    private PortefoljebrukerFrontendModell2 addAvtaltAktivitetUtlopsdato(String type, Timestamp utlopsdato) {
