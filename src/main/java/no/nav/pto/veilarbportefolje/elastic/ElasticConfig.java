...
public class ElasticConfig {
    ...
    @Bean
    public ElasticIndexer elasticIndexer(AktivitetDAO aktivitetDAO, BrukerRepository brukerRepository, PepClient pepClient, VeilarbVeilederClient veilarbVeilederClient, UnleashService unleashService) {
