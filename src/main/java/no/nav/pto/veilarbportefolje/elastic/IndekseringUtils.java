...
import no.nav.pto.veilarbportefolje.feedconsumer.aktivitet.AktivitetTyper;
import no.nav.pto.veilarbportefolje.elastic.domene.OppfolgingsBruker;
import no.nav.pto.veilarbportefolje.feedconsumer.aktivitet.AktivitetUtils;

import java.util.List;

import static no.nav.pto.veilarbportefolje.feedconsumer.aktivitet.AktivitetTyper.mote;
