...
public class ElasticServiceV2 {
    ...
    private final RestHighLevelClient restHighLevelClientSupplier;

    public ElasticServiceV2(RestHighLevelClient restHighLevelClient, String index) {
        this.restHighLevelClientSupplier = restHighLevelClient;
        this.indeks = index;
    }
    ...
    public Optional<AktoerId> hentAktoerId(Fnr fnr){
        ...
        try {
            GetResponse a = restHighLevelClientSupplier.get(getRequest, DEFAULT);
    ...
    public void updateHarDeltCv(Fnr fnr, boolean harDeltCv) {
        ...
        try {
            restHighLevelClientSupplier.update(updateRequest, DEFAULT);
        } catch (ElasticsearchException e) {
            if (e.status() == RestStatus.NOT_FOUND) {
    ...
    private <T> T search(SearchSourceBuilder searchSourceBuilder, Class<T> clazz) {
        ...
        SearchResponse response = restHighLevelClientSupplier.search(request, RequestOptions.DEFAULT);
