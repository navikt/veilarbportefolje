...
public class FeatureToggle {
    ...
    public static final String DISABLE_INDEKSERING = "veilarbportefolje.disable_indeksering";
    ...
    public static boolean disableIndeksering(UnleashService unleashService) {
        return unleashService.isEnabled(FeatureToggle.DISABLE_INDEKSERING);
    }
}
