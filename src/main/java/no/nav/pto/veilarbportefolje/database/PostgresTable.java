...
public class PostgresTable {
    public static final class OPENSEARCHDATA {
        ...
        public static final String YTELSER_UNGDOMSPROGRAM_FRA_OG_MED = "YTELSER_UNGDOMSPROGRAM_FRA_OG_MED";
        public static final String YTELSER_UNGDOMSPROGRAM_TIL_OG_MED = "YTELSER_UNGDOMSPROGRAM_FRA_OG_MED";
        public static final String YTELSER_UNGDOMSPROGRAM_MAKSDATO = "YTELSER_UNGDOMSPROGRAM_FRA_OG_MED";
        public static final String YTELSER_UNGDOMSPROGRAM_HAR_FORLENGET_PERIODE = "YTELSER_UNGDOMSPROGRAM_FRA_OG_MED";
