...
@Slf4j
@RestController
@RequestMapping("/api/v2/arbeidsliste")
public class ArbeidsListeControllerV2 {
    ...
    @Autowired
    public ArbeidsListeControllerV2(
            @Qualifier("PostgresArbeidslisteService") ArbeidslisteService arbeidslisteService,
