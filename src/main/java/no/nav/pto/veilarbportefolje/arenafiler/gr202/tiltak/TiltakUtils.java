...
import static no.nav.pto.veilarbportefolje.feed.aktivitet.AktivitetUtils.etterFilterDato;
...
public class TiltakUtils {
    ...
    public static AktivitetStatus utledAktivitetstatusForTiltak(Bruker bruker, PersonId personId) {
    ...
    public static AktivitetStatus utledGruppeaktivitetstatus(Bruker bruker, PersonId personId) {
