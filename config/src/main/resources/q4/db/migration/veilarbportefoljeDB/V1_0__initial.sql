...
AS
  SELECT *
  FROM SIKKERHETSTILTAK_TYPE@areq04;
...
AS
  SELECT *
  FROM RETTIGHETSGRUPPETYPE@areq04;
...
AS
  SELECT *
  FROM KVALIFISERINGSGRUPPETYPE@areq04;
...
AS
  SELECT *
  FROM FORMIDLINGSGRUPPETYPE@areq04;